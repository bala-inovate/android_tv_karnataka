...
/root/android_tv/adb -s $i push         /data/karna/*.mp4    /sdcard/Download/$thismonth 
if  [[ $? -eq 0 ]]; then
echo $i >> ./karnataka-success-ip.txt  &&  echo "The video content is moved successfully to this device $i ." | mail -s "Karnataka tv content movement of $thismonth month" it@vcaregroup.in
echo "done"
fi
}
